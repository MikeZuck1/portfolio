...
export default function Navigation() {
  ...
  return (
    <nav className="bg-[#121826] shadow-md w-full z-50 mt-[1rem] rounded-4xl border-2 border-solid">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
        ...
        <div className="hidden md:flex space-x-6">
          ...
          <NavLink href="/skills">Projets</NavLink>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-[#121826] shadow-md absolute top-16 left-0 w-full py-4">
          <div className="flex flex-col items-center space-y-4">
            <NavLink href="/components/ui-custom/About/About.tsx">
              À propos
            </NavLink>
